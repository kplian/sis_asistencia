    ...
    ***********************************/
    ...
    IF (p_transaccion='ASIS_TLT_INS') THEN
        ...
        BEGIN
           ...
           where pm.codigo = 'TTO' and tp.estado_reg = 'activo' and tp.inicio = 'si';
           ...
           SELECT
            ...
            INSERT INTO asis.ttele_trabajo(
            estado_reg,
            id_funcionario,
            id_responsable,
            fecha_inicio,
            ...
            v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Tele Trabajo almacenado(a) con exito (id_tele_trabajo'||v_id_tele_trabajo||')'); 
    ...
    ***********************************/
    ...
    ELSIF (p_transaccion='ASIS_TLT_ELI') THEN
        ...
        BEGIN
            ...
            DELETE FROM asis.ttele_trabajo
            WHERE id_tele_trabajo=v_parametros.id_tele_trabajo;
