...
BEGIN
    ...
    select    v.id_vacacion,
              ...
              v.reponsable,
              v.codigo_res,
              COALESCE(v.solicitante_tercero,'') as solicitante_tercero,
              COALESCE(v.codigo_terc,'') as codigo_terc,
              COALESCE(v.codigo_secretaria,'') as codigo_secretaria,
              COALESCE(v.secretaria,'') as secretaria,
              v.descripcion,
              v.dias,
              v.saldo,
              v.id_usuario_reg,
