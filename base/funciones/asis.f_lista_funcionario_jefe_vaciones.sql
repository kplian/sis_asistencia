CREATE OR REPLACE FUNCTION asis.f_lista_funcionario_jefe_vaciones (
...
/**************************************************************************
 SISTEMA
***************************************************************************
 SCRIPT: 		     cd.f_lista_funcionario_jefe_superior_wf_sel
...
BEGIN
    ...
    v_nombre_funcion ='cd.f_lista_funcionario_jefe_superior_wf_sel';
...
ALTER FUNCTION asis.f_lista_funcionario_jefe_vaciones (p_id_usuario integer, p_id_tipo_estado integer, p_fecha date, p_id_estado_wf integer, p_count boolean, p_limit integer, p_start integer, p_filtro varchar)
  OWNER TO dbaamamani;