CREATE OR REPLACE FUNCTION asis.f_lista_funcionario_jefe (
...
ALTER FUNCTION asis.f_lista_funcionario_jefe (p_id_usuario integer, p_id_tipo_estado integer, p_fecha date, p_id_estado_wf integer, p_count boolean, p_limit integer, p_start integer, p_filtro varchar)
  OWNER TO dbaamamani;