CREATE OR REPLACE FUNCTION asis.ft_tipo_permiso_ime (
...
BEGIN
	...
	***********************************/
	...
	if(p_transaccion='ASIS_TPO_INS')then
        ...
        begin
			...
			v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Tipo Permiso almacenado(a) con exito (id_tipo_permiso'||v_id_tipo_permiso||')');
	...
	***********************************/
		...
		begin
			...
			delete from asis.ttipo_permiso
            where id_tipo_permiso=v_parametros.id_tipo_permiso;
