CREATE OR REPLACE FUNCTION asis.f_generar_asistencia (
  p_fecha date,
...
ALTER FUNCTION asis.f_generar_asistencia (p_fecha date, p_id_funcionario integer, p_horas_array varchar [])
  OWNER TO dbaamamani;