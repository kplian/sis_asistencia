    ...
    ***********************************/
    ...
    IF (p_transaccion='ASIS_PRN_INS') THEN
        ...
        BEGIN
            ...
            INSERT INTO asis.tprogramacion(
            estado_reg,
            id_periodo,
            fecha_programada,
            id_funcionario,
            ...
            v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Programacion almacenado(a) con exito (id_programacion'||v_id_programacion||')'); 
    ...
    ***********************************/
    ...
    ELSIF (p_transaccion='ASIS_PRN_MOD') THEN
        ...
        BEGIN
            ...
            id_vacacion_det = v_parametros.id_vacacion_det,
    ...
    ***********************************/
    ...
    ELSIF (p_transaccion='ASIS_PRN_ELI') THEN
        ...
        BEGIN
            ...
            DELETE FROM asis.tprogramacion
            WHERE id_programacion=v_parametros.id_programacion;
