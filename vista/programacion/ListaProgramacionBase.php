...
/****************************************************************************************
 * @package pXP
 * @file ListaProgramacionBase.php
 * @author  (valvarado)
...
?>
<script>
    Phx.vista.ListaProgramacionBase = Ext.extend(Phx.gridInterfaz, {

            constructor: function (config) {
                this.maestro = config.maestro;
                Phx.vista.ListaProgramacionBase.superclass.constructor.call(this, config);
