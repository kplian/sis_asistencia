...
<script>
    Phx.vista.FormFiltroTele=Ext.extend(Phx.frmInterfaz,{
        constructor:function(config){
            ...
            Phx.vista.FormFiltroTele.superclass.constructor.call(this,config);
            this.init();
            this.inicialEvento();
           if(config.detalle){
        ...
        east: {
            url: '../../../sis_asistencia/vista/consulta_rrhh/TeleTrabajoRrhh.php',
            title: 'Filtros',
            width: '70%',
            cls: 'TeleTrabajoRrhh'
        },
      ...
      loadValoresIniciales: function(){
           Phx.vista.FormFiltroTele.superclass.loadValoresIniciales.call(this);
       }
