...
class RReporteVacacionPDF extends  ReportePDF
{
    ...
    function Header(){
        ...
        $this->SetFontSize(12);
        $this->SetFont('', 'B');
        $this->MultiCell(105, 25, "\n" . 'PERSONAL EN VACACIÓN'. "\n".'de: '.$this->objParam->getParametro('fecha_ini').' al: '.$this->objParam->getParametro('fecha_fin'), 0, 'C', 0, '', '');
    ...
    function reporteRequerimiento(){
        ...
        $table = '
             <table cellspacing="0" cellpadding="1" >
                  <tr>
                        ...
                        <th width="15%" style="border-top: 1px solid black; border-bottom: 1px solid black;" align="center"><b>DÍAS</b></th>
                        <th width="15%" style="border-top: 1px solid black; border-bottom: 1px solid black;" align="center"><b>FEC. INICIO</b></th>
                        <th width="15%" style="border-top: 1px solid black; border-bottom: 1px solid black;" align="center"><b>FEC. FIN</b></th>
                  </tr>
        ...
        foreach ($this->datos as $value){
            ...
            $table .= '  <td  width="15%" align="center" >'.$value['dia'].' </td>
                             <td  width="15%" align="center" >'.$value['desde'].'</td>
                            <td  width="15%" align="center" >'.$value['hasta'].'</td>';
            $table .= '</tr>';
            $imprimir= true;
        }
        $table .= '</table>';
