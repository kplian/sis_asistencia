 ...
 */
class RIncumplimientos extends  ReportePDF
{
    ...
    function Header(){
        ...
        $this->SetFontSize(15);
        $this->SetFont('', 'B');
        $this->MultiCell(105, $height,  "REPORTE DE INCUMPLIMIENTOS", 0, 'C', 0, '', '');
    ...
    function reporteRequerimiento(){
        ...
        foreach ($this->datos as $Row) {
			...
			//var_dump($this->saber_dia($fecha));
			if ($this->saber_dia($fecha) == 'Viernes'){
				if ((strtotime($hras_man) < strtotime("6:00:00"))){
					$tbl = '
				...
				if ((strtotime($hras_man) < strtotime("4:00:00"))||(strtotime($hras_tar) < strtotime("4:00:00"))){
					if (strtotime($hras_man) < strtotime("4:00:00")){$color1='red';} else {$color1='black';}
					if (strtotime($hras_tar) < strtotime("4:00:00")){$color2='red';} else {$color2='black';}
					$tbl = '
							<table cellspacing="0" cellpadding="1" border="1" >
								<tr style="background-color:'.$color_fila.'">
									<td width="63.5" align="center">'.$fecha.'</td>
									<td width="74.5" align="center">'.$hra_ent_m.'</td>
									<td width="74.5" align="center">'.$hra_sal_m.'</td>
									<td width="74.5" align="center"><font color="'.$color1.'">'.$hras_man.'</font></td>
									<td width="74.5" align="center">'.$hra_ent_t.'</td>
									<td width="74.5" align="center">'.$hra_sal_t.'</td>
									<td width="74.5" align="center"><font color="'.$color2.'">'.$hras_tar.'</font></td>
									<td width="74.5" align="center">'.$hras_dia.'</td>
									<td width="74.5" align="center"><font color="'.$color.'">'.$difr.$dif_hras.'</font></td>
								</tr>
							</table>
