    ...
    function Header(){
		...
		<table cellpadding="2" cellspacing = "0">
        	<tr>
            	...
            	<th style="width: 60%;vertical-align:middle;" align="center" rowspan="2"><br/><br/><h2>RESUMEN DE VACACIONES</h2></th>
...
EOF;
        ...
        $header = '<table cellspacing="0" cellpadding="1" >    
                 <tr>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="center"><b>CÓDIGO</b></th>
                        <th width="30%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="center"><b>EMPLEADO</b></th>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="right"><b>ACUMUL</b></th>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="right"><b>TOMADOS</b></th>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="right"><b>CADUCAD</b></th>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="right"><b>ANTICIPOS</b></th>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="right"><b>PAGADOS</b></th>
                        <th width="10%"  style="font-size: 10px; border-top: 1px solid black; border-bottom: 1px solid black;" align="right"><b>SALDO</b></th>
                  </tr>
                  </table>';
    ...
    function reporteRequerimiento(){
        ...
        foreach ($this->datos as $value){
                $table .= '<tr>';
                 $table .= ' 
                        <td width="10%" align="center" >' . $value['codigo'] . '</td>
