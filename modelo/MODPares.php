...
class MODPares extends MODbase{
    ...
    function listarPares(){
        ...
        $this->captura('desc_motivo','text');
        $this->captura('desc_dia','integer');
