...
class ACTMesTrabajoDet extends ACTbase{    
        ...
        function listarMesTrabajoDet(){
            ...
            //
            if ($this->objParam->getParametro('detalle')!= ''){
                switch ($this->objParam->getParametro('pes_estado')) {
                    case 'borrador':
                        $this->objParam->addFiltro("mes.estado = ''borrador''");
                        break;
                    case 'asignado':
                        $this->objParam->addFiltro("mes.estado = ''asignado''");
                        break;
                    case 'aprobado':
                        $this->objParam->addFiltro("mes.estado = ''aprobado''");
                        break;
                }
            }
            if ($this->objParam->getParametro('tipo_interfaz') == 'MesTrabajoDetConsulta'){
                    $this->objParam->addFiltro("mes.estado = ''asignado''");
            }
            if ($this->objParam->getParametro('tipo_interfaz') == 'MesTrabajoDetExtra'){
        ...
        function insertarCentro(){
            $this->objFunc=$this->create('MODMesTrabajoDet');
            $this->res=$this->objFunc->insertarCentro($this->objParam);
            $this->res->imprimirRespuesta($this->res->generarJson());
        }
        function insertarExtra(){
            $this->objFunc=$this->create('MODMesTrabajoDet');
            $this->res=$this->objFunc->insertarExtra($this->objParam);
            $this->res->imprimirRespuesta($this->res->generarJson());
        }
        function autorizarHorasExtras(){
            $this->objFunc=$this->create('MODMesTrabajoDet');
            $this->res=$this->objFunc->autorizarHorasExtras($this->objParam);
            $this->res->imprimirRespuesta($this->res->generarJson());
        }
    }
